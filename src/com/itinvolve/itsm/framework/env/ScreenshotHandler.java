...
public class ScreenshotHandler {
    ...
    public static String takeScreenshot(String nameScreenshot) {
        String path = null;
        try {
            File screenshot = ((TakesScreenshot) WebDriverHandler.driver).getScreenshotAs(OutputType.FILE);
    ...
    public static String captureScreenRegion(Point p, int width, int height, String imageFileName) {
        File screen = ((TakesScreenshot) WebDriverHandler.driver).getScreenshotAs(OutputType.FILE);
        String path = null;
        try {
