...
//    static String AUTHENDPOINT_SANDBOX = "https://test.salesforce.com/services/Soap/u/29.0";
    ...
    static final String USERNAME = "av.espinoza@hotmail.es";//"adrian@jalasoft.com.rina17";//
    static final String PASSWORD = "Adri@n123";//"Admin123";
...
//
        ...
        System.out.println(query.toSoql());
